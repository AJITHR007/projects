...
// Check if the request method is POST and 'leave_approvals_id' is set
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['leave_approvals_id'])) {
    ...
    if (updateStatus($requestId, '1')) {
        ...
        try {
            ...
            $mail->Body = 'Dear ' . $requestDetails['empName'] .',Your leave request has been Approved. If you have any concerns or questions, please contact the HR department.' . PHP_EOL . PHP_EOL . 'Best regards,' . PHP_EOL . 'Srays Team';
