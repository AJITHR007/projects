...
if (isset($_POST['update'])) {
   ...
   $update_profile->execute([$empName, $email, $user_id]);
       ...
       <form action="" method="post" enctype="multipart/form-data">
           ...
           <div class="flex">
               ...
               <div class="inputBox">
                   ...
                   <input type="password" class="box" name="previous_pass" id="old_pass"placeholder="Enter previous password">
                   <div id="passwordConditions" style="display: none;">
                        <p>Password must be 8-15 characters long, contain at least one uppercase letter, one lowercase letter, one number, and one special character.</p>
                    </div>
                   <span>New password:</span>
                    <input type="password" class="box" name="new_pass" id="new_pass" placeholder="Enter new password">
                    <div id="passwordConditions" style="display: none;">
                        <p>Password must be 8-15 characters long, contain at least one uppercase letter, one lowercase letter, one number, and one special character.</p>
                    </div>
