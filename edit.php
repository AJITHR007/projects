...
<body>
                    ...
                    <form id="form" action="onboardingupdate.php" method="POST">
                        <div class="row g-3 pb-4">
                          <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="empRec" id="empRecInput" onkeydown="validateEmpCode(event)" maxlength="6" minlength="6" onblur="validateEmpCode(event)" value="<?php echo isset($row["empRec"]) ? $row["empRec"] : ''; ?>">
                     ...
                     <div class="row g-3 pb-4">
                          <div class="col-md-4">
                           ...
                           <label for="country" class="form-label">Country</label>
                                <select name="country" id="countryId" class="form-select countries" onkeydown="countryvalidation(event)" onblur="countryvalidation(event)" value="<?php echo isset($row["countryId"]) ? $row["countryId"] : ''; ?>">
                          ...
                          <select name="state" id="stateId" class="form-select states" onkeydown="statevalidation(event)" onblur="statevalidation(event)" value="<?php echo isset($row["stateId"]) ? $row["stateId"] : ''; ?>">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="district" id="cityId" class="form-select cities" onkeydown="districtvalidation(event)" onblur="districtvalidation(event)" value="<?php echo isset($row["cityId"]) ? $row["cityId"] : ''; ?>">
                        ...
                        <div class="row g-3 pb-4">
                          ...
                          <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="username" id="username" maxlength="6" onkeydown="usernameValidation(event)" onblur="usernameValidation(event)"value="<?php echo isset($row["username"]) ? $row["username"] : ''; ?>"> 
                            <span id="error" style="color:red"></span>
  ...
  <div class="col-md-4">
                          ...
                          <select name="bank_name" id="bank_name" class="form-select" onkeyup="bankNameValidation(event)">
                              <option value="" <?php echo empty($row["bank_name"]) ? "selected" : ""; ?>>Select bank name</option>
                              <option value="Bank of India" <?php echo ($row["bank_name"] == "Bank of India") ? "selected" : ""; ?>>Bank of India</option>
                              <option value="Bank of Baroda" <?php echo ($row["bank_name"] == "Bank of Baroda") ? "selected" : ""; ?>>Bank of Baroda</option>
                              <option value="Canara Bank" <?php echo ($row["bank_name"] == "Canara Bank") ? "selected" : ""; ?>>Canara Bank</option>
                              <option value="Bank of Maharashtra" <?php echo ($row["bank_name"] == "Bank of Maharashtra") ? "selected" : ""; ?>>Bank of Maharashtra</option>
                              <option value="Punjab National Bank" <?php echo ($row["bank_name"] == "Punjab National Bank") ? "selected" : ""; ?>>Punjab National Bank</option>
                              <option value="State Bank of India" <?php echo ($row["bank_name"] == "State Bank of India") ? "selected" : ""; ?>>State Bank of India</option>
                              <option value="Indian Bank" <?php echo ($row["bank_name"] == "Indian Bank") ? "selected" : ""; ?>>Indian Bank</option>
                              <option value="Indian Overseas Bank" <?php echo ($row["bank_name"] == "Indian Overseas Bank") ? "selected" : ""; ?>>Indian Overseas Bank</option>
                              <option value="Axis Bank" <?php echo ($row["bank_name"] == "Axis Bank") ? "selected" : ""; ?>>Axis Bank</option>
                              <option value="HDFC Bank" <?php echo ($row["bank_name"] == "HDFC Bank") ? "selected" : ""; ?>>HDFC Bank</option>
                              <option value="Punjab and Sind Bank" <?php echo ($row["bank_name"] == "Punjab and Sind Bank") ? "selected" : ""; ?>>Punjab and Sind Bank</option>
                              <option value="UCO Bank" <?php echo ($row["bank_name"] == "UCO Bank") ? "selected" : ""; ?>>UCO Bank</option>
                              <option value="ICICI Bank" <?php echo ($row["bank_name"] == "ICICI Bank") ? "selected" : ""; ?>>ICICI Bank</option>
                              <option value="IndusInd Bank" <?php echo ($row["bank_name"] == "IndusInd Bank") ? "selected" : ""; ?>>IndusInd Bank</option>
                              <option value="Allahabad Bank" <?php echo ($row["bank_name"] == "Allahabad Bank") ? "selected" : ""; ?>>Allahabad Bank</option>
                              <option value="Dena Bank" <?php echo ($row["bank_name"] == "Dena Bank") ? "selected":""; ?>>Dena Bank</option>
                              <option value="Federal Bank" <?php echo ($row["bank_name"] == "Federal Bank") ? "selected" : ""; ?>>Federal Bank</option>
                              <option value="IDBI Bank" <?php echo ($row["bank_name"] == "IDBI Bank") ? "selected" : ""; ?>>IDBI Bank</option>
                              <option value="Karnataka Bank" <?php echo ($row["bank_name"] == "Karnataka Bank") ? "selected" : ""; ?>>Karnataka Bank</option>
                              <option value="Kotak Mahindra Bank" <?php echo ($row["bank_name"] == "Kotak Mahindra Bank") ? "selected" : ""; ?>>Kotak Mahindra Bank</option>
                              <option value="Andhra Bank" <?php echo ($row["bank_name"] == "Andhra Bank") ? "selected" : ""; ?>>Andhra Bank</option>
                              <option value="CSB Bank" <?php echo ($row["bank_name"] == "CSB Bank") ? "selected" : ""; ?>>CSB Bank</option>
                              <option value="DCB Bank" <?php echo ($row["bank_name"] == "DCB Bank") ? "selected" : ""; ?>>DCB Bank</option>
                              <option value="Oriental Bank of Commerce" <?php echo ($row["bank_name"] == "Oriental Bank of Commerce") ? "selected" : ""; ?>>Oriental Bank of Commerce</option>
                          </select>
                          <span id="error" style="color:red"></span>
                      </div>
                      <div class="col-md-4">
                          <label for="branch_name" class="form-label">Branch Name</label>
                            <input type="text" class="form-control" name="branch_name" id="branch_name" maxlength="30" onkeyup="motherNamevalidation(event)" value="<?php echo isset($row["branch_name"]) ? $row["branch_name"] : ''; ?>">
                            <span id="error" style="color:red"></span>
                          </div>
                          <div class="col-md-4">
...
<div class="col-md-4">
    ...
    <span id="error" style="color:red"></span>
                       ...
                       <input type="text" class="form-control" name="passport" id="passport" minlength="8" maxlength="12" onkeyup="passportValidation(event)" onblur="passportValidation(event)" value="<?php echo isset($row["passport"]) ? $row["passport"] : ''; ?>">
                       <span id="error" style="color:red"></span>
                          </div>
                        <div class="row pt-2">
...
<script>
  ...
  $('#passportStatus').change(function(e) {
    ...
    else if (selected_type == 'yes' || selected_type == 'Divorced') { //if B is selected
  ...
  $('#work_experience').change(function(e) {
    ...
    else if (selected_type == '1year' || selected_type == 'Divorced') { //if B is selected
...
<script>
      ...
      echo "<script>alert('update successfully!'); window.location='ray.php';</script>";
 </body>
</html>