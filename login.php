        ...
        if ($row['pass'] != $pass) {
            ...
            if ($row['active'] == '0') {
                if ($row['usertype'] == 'user') {
                    ...
                    header('Location: http://localhost/final/empdash.php');
...
<body><div class="logo">
        ...
        <div class="container">
    <center>   <p> <h2>Welcome User</h2>  <p> </center>
       <center> <h2>Login</h2></center>
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" onsubmit="return validateForm()">
            ...
            <a href="password.php">Forgot Password?</a> <!-- Link to the forgot password page -->
