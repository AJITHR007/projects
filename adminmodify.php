        ...
        <div class="container m-3">
            <div class="row rounded">
                <div class="col-md-3 purpleBox rounded-start-2 position-relative">
                    <h4 class="text-white" style="margin-top: 200px;">My profile</h4>
                     </div>
                  ...
                  <h3>My Profile</h3>
                    ...
                    <div class="row g-3 pb-4">
                          <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="empRec" id="empRecInput" onkeydown="validateEmpCode(event)" maxlength="6" minlength="6" onblur="validateEmpCode(event)" value="<?php echo isset($fetch_profile["empRec"]) ? $fetch_profile["empRec"] : ''; ?>" readonly>
                            <span id="error" style="color:red"></span>
                          </div>
                          <div class="col-md-4">
                            <label for="empName" class="form-label">Employee Full Name</label>
                            <input type="text" class="form-control" name="empName" id="empName" minlength="3" maxlength="25" onkeyup="empNamevalidation(event)" onblur="empNamevalidation(event)" value="<?php echo isset($fetch_profile["empName"]) ? $fetch_profile["empName"] : ''; ?>" readonly>
                            <span id="error" style="color:red"></span>
                          </div>
                            <div class="col-md-4">
                           <label for="dob" class="form-label">Date of Birth</label>
                            <input type="date" class="form-control" name="dob" id="dob" onkeydown="dobvalidation(event)" onchange="submitBday(event)" onblur="dobvalidation(event)" value="<?php echo isset($fetch_profile["dob"]) ? $fetch_profile["dob"] : ''; ?>" readonly>
                            <span id="error" style="color:red"></span>
                          </div>
                        </div>
                        ...
                        <div class="row g-3 pb-4">
                          ...
                          <div class="col-md-4">
                           ...
                           <option value="Male" <?php echo ($fetch_profile["gender"] == "Male") ? "selected" : ""; ?>>Male</option>
                           <option value="female" <?php echo ($fetch_profile["gender"] == "Female") ? "selected" : ""; ?>>Female</option>
                           <option value="others" <?php echo ($fetch_profile["gender"] == "Others") ? "selected" : ""; ?>>Others</option>
                           </select>
                            <span id="error" style="color:red"></span>
                          </div>
                            <div class="col-md-4">
...
<script>
    const dropDownValueSetter = setInterval(() => {
        var country_val = "<?php echo $row['countryId']?>";
        ...
        stateElement.val(stateVal);
        
        var districtVal = "<?php echo $row['cityId']?>";
        var districtElement = $('#cityId'); 
        districtElement.val(districtVal);

        clearInterval(dropDownValueSetter); // Clear the interval after setting dropdown values
    }, 2000);
</script>
